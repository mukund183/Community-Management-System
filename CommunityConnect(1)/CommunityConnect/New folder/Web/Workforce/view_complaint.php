...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM complaints WHERE problem = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("s", $asplace);
    $stmt->execute();
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<thead><tr><th>Place</th><th>Time</th><th>Problem</th><th>Tower no</th><th>Flat no</th></tr></thead>";
        echo "<tbody>";
